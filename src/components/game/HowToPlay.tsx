      ...
      <div className="bg-[#111] border border-white/10 rounded-2xl p-6 w-full max-w-sm">
        ...
        <ul className="space-y-3 text-sm text-white/50 leading-relaxed">
          ...
          <li className="flex gap-3">
            ...
            <span>Minimum 3 letters per word. Each letter can only be used as many times as it appears.</span>
          </li>
          <li className="flex gap-3">
            <span className="text-white/20 font-semibold">4.</span>
            <span>Longer words earn more points. 3 letters = 300pts, 4 letters = 400pts and so on.</span>
          </li>
          <li className="flex gap-3">
            <span className="text-white/20 font-semibold">5.</span>
            <span>Find as many words as possible before the timer runs out.</span>
          </li>
        </ul>

        {/* Tip */}
        <div className="mt-5 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-xs text-white/30">
          Tip: Hit shuffle to rearrange the letters if you're stuck. Use give up to end the round early and see missed words.
        </div>
